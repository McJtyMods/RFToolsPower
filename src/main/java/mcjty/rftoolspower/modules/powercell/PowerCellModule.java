...
public class PowerCellModule implements IModule {
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_CELL1 = TILES.register("cell1", () -> TileEntityType.Builder.of(() -> new PowerCellTileEntity(Tier.TIER1), CELL1.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_CELL2 = TILES.register("cell2", () -> TileEntityType.Builder.of(() -> new PowerCellTileEntity(Tier.TIER2), CELL2.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_CELL3 = TILES.register("cell3", () -> TileEntityType.Builder.of(() -> new PowerCellTileEntity(Tier.TIER3), CELL3.get()).build(null));
