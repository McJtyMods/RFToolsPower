...
public class EndergenicModule implements IModule {
    ...
    public static final RegistryObject<Item> ENDER_MONITOR_ITEM = ITEMS.register("ender_monitor", tab(() -> new BlockItem(ENDER_MONITOR.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> PEARL_INJECTOR_ITEM = ITEMS.register("pearl_injector", tab(() -> new BlockItem(PEARL_INJECTOR.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> ENDERGENIC_ITEM = ITEMS.register("endergenic", tab(() -> new BlockItem(ENDERGENIC.get(), Registration.createStandardProperties())));
