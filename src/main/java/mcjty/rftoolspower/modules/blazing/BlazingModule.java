...
public class BlazingModule implements IModule {
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_BLAZING_GENERATOR = TILES.register("blazing_generator", () -> TileEntityType.Builder.of(BlazingGeneratorTileEntity::new, BLAZING_GENERATOR.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<BlazingAgitatorTileEntity>> TYPE_BLAZING_AGITATOR = TILES.register("blazing_agitator", () -> TileEntityType.Builder.of(BlazingAgitatorTileEntity::new, BLAZING_AGITATOR.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_BLAZING_INFUSER = TILES.register("blazing_infuser", () -> TileEntityType.Builder.of(BlazingInfuserTileEntity::new, BLAZING_INFUSER.get()).build(null));
